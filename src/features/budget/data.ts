...
export const brlFull = (value: number) =>
  value.toLocaleString("pt-BR", {
    style: "currency",
    currency: "BRL",
...
export type Approval = {
  ...
  centro: string;
  valor: number;
  nivel: "N1 Gerente" | "N2 Diretor" | "N3 Comitê";
  solicitante: string;
  prazo: string;
  status: "pendente" | "urgente";
};

/** Alçada sugerida conforme valor (mesma lógica da matriz em Configurações). */
export function approvalLevelForAmount(valor: number): Approval["nivel"] {
