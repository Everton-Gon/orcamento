import { reportsCatalog, type ReportCatalogItem } from "@/features/budget/data";
...
function buildReportFile(r: ReportCatalogItem) {
  const body = [
    `Relatório: ${r.nome}`,
    `Período: ${r.periodo}`,
...
export function ReportsDownloadsCard() {
  const handleDownload = (r: ReportCatalogItem) => {
